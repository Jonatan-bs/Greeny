                    ...
                    <div class="wcbwidget-newsletter-form">
                        <div class="wcbwidget-input-group">
                            ...
                            <div class="wcbwidget-input-group-btn">
                                <span class="wcbwidget-btn wcbwidget-btn-primary wcbwidget-button"><?php echo $this->settings->get_params( 'wcb_button_text' ) ?></span>
                            </div>
                        </div>
                    </div>
					<?php
...
// Insert the post into the database
	...
	public function send_email( $user_email, $customer_name, $coupon_code, $date_expires = '', $coupon_value = '' ) {
		...
		$content         = str_replace( '{last_valid_date}', empty( $date_expires ) ? '' : date( 'Y-m-d', strtotime( $date_expires ) - 86400 ), $content );
