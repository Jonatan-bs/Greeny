    ...
    <div class="content py">
        <div class="cards">
            <div class="card text-display animate slideIn sequence">
                <img  class="symbol" src="<?php echo get_template_directory_uri() ?>/images/symbol1-light.svg" alt="Greeny Juices - sachets symbol" >
            ...
            <div class="card text-display  animate slideIn sequence">
                <img  class="symbol" src="<?php echo get_template_directory_uri() ?>/images/symbol3-light.svg" alt="Cut down on food waste - illustration" >
                <p class="display-sm color-light">It helps you help the world and save money, by cutting down on food waste</p>
            </div>
            <div class="card text-display  animate slideIn sequence">
                <img  class="symbol" src="<?php echo get_template_directory_uri() ?>/images/symbol2-light.svg" alt="Yum!" >
                <p class="display-sm color-light">It’s fully natural, nutritious and delicious!
</p>
            </div>
            <div class="card text-display  animate slideIn sequence">
                <img  class="symbol" src="<?php echo get_template_directory_uri() ?>/images/symbol4-light.svg" alt="tailored to your specific needs - illustration" >
